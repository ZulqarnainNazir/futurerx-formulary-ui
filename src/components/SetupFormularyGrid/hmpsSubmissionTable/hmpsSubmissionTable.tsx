                ...
                <Card style={{ border: "1px solid lightgrey", }} className="header">
                    ...
                    <div className="grid-container">
                        ...
                        <div style={{ borderRight: "0px solid white" }} className="grid-item">
                            <span style={{ display: "flex", justifyContent: "start", fontSize: "12px", color: "#666666", }}>Excluded Drug</span>
                        </div>
                        <div style={{ borderLeft: "0px solid white" }} className="grid-item">
                            <span style={{ display: "flex", justifyContent: "start", color: "#666666", }}>label</span>
                        </div>
                        <div className="grid-item">
                        ...
                        <div style={{ borderRight: "0px solid white" }} className="grid-item">
                            <span style={{ display: "flex", justifyContent: "start", color: "#666666", }}>Free First Fill</span>
                        </div>
                        <div style={{ borderLeft: "0px solid white" }} className="grid-item">
                            <span style={{ display: "flex", justifyContent: "start", color: "#666666", }}>label</span>
                        </div>
                        ...
                        <div style={{ borderRight: "0px solid white" }} className="grid-item">
                            <span style={{ display: "flex", justifyContent: "start", color: "#666666", }}>Home Infusion</span>
                        </div>
                        <div style={{ borderLeft: "0px solid white" }} className="grid-item">
                            <span style={{ display: "flex", justifyContent: "start", color: "#666666", }}>label</span>
                        </div>
                        ...
                        <div style={{ borderRight: "0px solid white" }} className="grid-item">
                            <span style={{ display: "flex", justifyContent: "start", color: "#666666", }}>HPMS Delta Formulary File</span>
                        </div>
                        <div style={{ borderLeft: "0px solid white" }} className="grid-item">
                            <span style={{ display: "flex", justifyContent: "start", color: "#666666", }}>label</span>
                        </div>
                        ...
                        <div style={{ borderRight: "0px solid white" }} className="grid-item">
                            <span style={{ display: "flex", justifyContent: "start", color: "#666666", }}> HPMS Full Formulary File</span></div>
                        <div style={{ borderLeft: "0px solid white" }} className="grid-item">
                            <span style={{ display: "flex", justifyContent: "start", color: "#666666", }}>label</span>
                        </div>
