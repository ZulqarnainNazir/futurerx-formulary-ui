    ...
    return (
        <div className="drug-detail-top">
            ...
            <div className="durationInfo d-flex">
                <div className="item"><span className="tag purple">Medicare</span></div>
                <div className="item"><span className="label">Formulary ID:</span> {props.formularyTopData.formularyID}</div>
                <div className="item"><span className="label">Effective Date:</span> {props.formularyTopData.effectiveDate}</div>
                <div className="item"><span className="label">Termination Date:</span> {props.formularyTopData.terminationDate}</div>
            </div>
        </div>
    )
}