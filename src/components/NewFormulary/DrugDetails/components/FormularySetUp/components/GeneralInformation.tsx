        ...
        return (
            <div className="general-information-container">
                ...
                <Grid container>
                    <Grid item xs={4}>
                        <div className="group">
                            <label>FORMULARY TYPE <span className="astrict">*</span></label>
                            <DropDown className="formulary-type-dropdown" placeholder="Commercial" options={["Commercial","Medicare",3]}/>
                        </div>
                    </Grid>
                    <Grid item xs={4}>
                        <div className="group">
                    ...
                    <Grid item xs={8}>
                        <div className="group">
                            <label>Method of Formulary Build <span className="astrict">*</span></label>
                    ...
                    <Grid item xs={4}>
                        <div className="group">
                            <label>SERVICE YEAR <span className="astrict">*</span></label>
                            <DropDown className="formulary-type-dropdown" options={[2018,2019,2020]}/>
                        </div>
                    </Grid>
                    <Grid item xs={8}>
                        <div className="group">
                    ...
                    <Grid item xs={4}>
                        <div className="group reporting-tag-group">
                            ...
                            <input type="text" className="reporting-tags" />
                            <svg className="reporting-tag-icon" width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="" className="add-tag">Add a tag</a>
                        </div>
                    </Grid>
                </Grid>
                </div>
