...
function PAGroupHeader(props: any) {
  ...
  return (
    <div className={`version-wrapper version-wrapper${panelColor}`}>
      ...
      <div className="item" onClick={props.isPopUpView? () => {} : toggleShowViewAll}>
      ...
      <div className="item" onClick={props.isPopUpView? () => {} : () => handleClickOpen("clone")}>
      ...
      <div className="item" onClick={props.isPopUpView? () => {} : () => handleClickOpen("newVersion")}>
      ...
      <div className="item" onClick={props.isPopUpView? () => {} : () => handleClickOpen("delete")}>
        <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
      ...
      <div className="item" onClick={props.isPopUpView? () => {} : () => handleClickOpen("archive")}>
        <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
