...
function PAGroupHeader(props: any) {
  ...
  useEffect(() => {
    ...
    if (props.version.length > 0) {
      ...
      setSelectedVersionId(versions[verLength - 1]["id_pa_group_description"]);
  ...
  const onChange = (e) => {
    ...
    if (verLength > 0 && selectedVersion != "") {
      ...
      if (is_setup) {
        ...
        isEditable = props.version.find((val) => val.version_number == Number(selectedVersion.split(" ")[1]))
          .is_setup_complete;
        latestVerion =
          verLength > 0
            ? props.version.find((val) => val.version_number == Number(selectedVersion.split(" ")[1]))
                .id_pa_group_description
            : 0;
      }
  ...
  return (
    <div className={`version-wrapper version-wrapper${panelColor}`}>
      ...
      <div className="item item--version-history" onClick={props.isPopUpView? () => {} :toggleShowViewAll}>
        <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            fill={panelColor === "-green" ? "#219653" : (panelColor === "-grey" ? "#9eb5a4" : "#f65a1c")}
          />
        </svg>
        Version History
      </div>
      <div className="item item--version-history" onClick={props.isPopUpView? () => {} : () => handleClickOpen("clone")}>
      ...
      <div className="item item--version-history" onClick={props.isPopUpView? () => {} : () => handleClickOpen("newVersion")}>
      ...
      <div className="item item--version-history" onClick={props.isPopUpView? () => {} : () => handleClickOpen("delete")}>
        <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
      ...
      <div className="item  item--version-history" onClick={props.isPopUpView? () => {} : () => handleClickOpen("archive")}>
        <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      {open ? (
        <STAlertDialog popuptitle={props.popuptitle} openPopup={open} closePopup={handleClose} popupType={popupType}>
          <Alerts
