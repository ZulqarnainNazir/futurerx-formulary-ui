...
function PAGroupHeader(props: any) {
  ...
  return (
    <div className={`version-wrapper version-wrapper${
      props.isSetupComplete === true ? ( props.isPopUpView? "-grey" : "-green" ) : (( props.isPopUpView? "-grey" : "-orange" )) 
    }`}
  >
      <select
      ...
      >
        ...
        >
          <path
            ...
            fill={
              props.isSetupComplete === true ? ( props.isPopUpView? "#8DD5A2" : "#219653" ) 
              : (( props.isPopUpView? "#8DD5A2" : "#f65a1c" )) 
            }
          />
        </svg>
        Version History
