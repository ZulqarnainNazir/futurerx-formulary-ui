            ...
            <div className="inner-container">
                ...
                {props.formType===0 && (<div className="setting-1 mb-20">
                    ...
                    <div className="marketing-material-chk radio-group">
                        <FormControlLabel control={<Checkbox name="is_rx_drug_type" color="primary" checked={formData.is_rx_drug_type} value='RX'/>} label='RX' disabled={editable}/>
                        <FormControlLabel control={<Checkbox name="is_otc_drug_type" checked={formData.is_otc_drug_type} value='OTC'/>} label='OTC' disabled={editable}/>
                    </div>
                    <Grid container>
                        <Grid item xs={6}>
                            <div className="group">
