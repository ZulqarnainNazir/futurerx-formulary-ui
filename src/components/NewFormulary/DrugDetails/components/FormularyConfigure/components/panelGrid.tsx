...
class PanelGrid extends React.Component<any,any>{
    render(){
        ...
        const classesArray = this.props.panelTitleAlignment !== undefined ? this.props.panelTitleAlignment : null;
        ...
        let panelGridBottom = <div className="row"><div className="item no-data">No Rows to Display</div></div>;
