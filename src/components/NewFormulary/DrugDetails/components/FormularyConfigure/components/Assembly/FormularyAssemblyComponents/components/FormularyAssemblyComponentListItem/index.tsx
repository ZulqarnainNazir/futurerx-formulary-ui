      ...
      <div className="formulary-assembly-component-list-item">
        <div className="formulary-assembly-component-list-item__container">
          ...
          <div className="formulary-assembly-component-list-item__title-container">  
            <div className="formulary-assembly-component-list-item__title">{this.props.title}</div>
            <span className="formulary-assembly-component-list-item__tag">{this.props.tag}</span>
          </div>
        ...
        <div className="formulary-assembly-component-list-item__description">{this.props.description}</div>
      </div>
    );
  }
}
