...
class DrugDetailAF extends React.Component<any,tabsState> {
  ...
  render() {
    return (
      <div className="drug-detail-AF-root">
      <div className="drug-detail-af-container">
        <div className="drug-detail-af-inner">
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <div className="abridged-formulary">
              <PanelHeader 
                ...
                <div className="abridged-formulary-inner">
