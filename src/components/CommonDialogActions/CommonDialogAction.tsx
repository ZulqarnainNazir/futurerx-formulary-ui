        ...
        <Grid container>
            ...
            <Grid item xs={5}>
                <div className="icon-list-wrapper">
                    ...
                    <HelpIcon className="marginRight" onClick={(e) => this.handleIconClick("help", "HELP")} />
                    <QAiconcon className="marginRight" onClick={(e) => this.handleIconClick("qa", "QUSTIONS AND ANSWERS")} />
                    <ImportIcon className="marginRight" onClick={(e) => this.handleIconClick("import", "IMPORT")} />
                    <ExportIcon className="marginRight" onClick={(e) => this.handleIconClick("export", "EXPORT")} />
                    <BazariconIcon className="marginRight" onClick={(e) => this.handleIconClick("bazar", "BUY FROM THE BAZAAR")} />
                    <SearchcIcon className="marginRight" onClick={(e) => this.handleIconClick("search", "Advance Search")} />
                    <ProfileIcon className="marginRight" onClick={(e) => this.handleIconClick("profile", "")} />
                    </div>
                </div>
                <DialogPopup
